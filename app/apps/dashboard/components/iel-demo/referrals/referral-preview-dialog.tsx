...
import { Alert, Button, Dialog } from '@workspace/ui';
...
export function ReferralPreviewDialog({
  ...
  return (
    <Dialog
      ...
      onHide={onHide}
      size="lg"
      header="O que a empresa vai receber"
      description={`${company?.name} · ${job.title}`}
      footer={
        <Button
          variant="outline"
          onClick={onHide}
    ...
    >
      <div className="space-y-4">
        ...
        <Alert variant="default">
          ...
          empresas, avaliações não autorizadas e o histórico de análise. Nada é
          enviado ao sistema de origem nesta demonstração.
        </Alert>
      </div>
    </Dialog>
  );
