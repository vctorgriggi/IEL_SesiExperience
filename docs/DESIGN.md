...
- **Com critério.** Cor em: badge de estado, selo de variação, número e barra de "combina", os dois lados do trilho e o ícone de contexto dos cartões. Sem cor em: títulos, textos de apoio, bordas e fundos de card, cabeçalhos de tabela e o número principal dos KPIs (fica em `foreground`). No máximo um ou dois pontos de cor por cartão.
