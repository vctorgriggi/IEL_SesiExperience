...
| --------------------- | ------------------------------------------------------------------- | ------------------------------------------------- |
| Jeito de entregar     | conferir cada etapa, uma coisa de cada vez, reunir informação antes | correr, alternar, decidir sem tudo                |
| Mudanças e novidades  | preferir o método já testado, esperar a mudança firmar              | adotar a novidade logo                            |
| Aprender coisas novas | conhecer outras atividades, começar sem todos os detalhes           | ficar na rotina principal                         |
| Pensar em quem recebe | concentrar-se na própria tarefa, sem depender de interação          | trabalho que depende de conversa e de quem recebe |
| Segurança e respeito  | ajustar a forma de fazer quando aperta, seguir sem confirmar        | manter o ritmo, confirmar cada etapa              |
| Ritmo do turno        | ritmo constante, uma demanda de cada vez                            | alternar entre demandas que chegam juntas         |
| Regras e decisões     | entender a regra e as consequências antes                           | decidir rápido, tentar o jeito novo               |
| Convivência           | combinados direto com a pessoa, ajudar fora da própria tarefa       | recado curto, cada um no seu                      |
| Autonomia             | organizar-se sozinho depois do objetivo                             | acompanhamento próximo                            |
| Carreira e futuro     | reorganizar horário quando precisa, trajetória estável              | horário fixo, mudar de trajetória                 |
...
- **Mapeamento tema a tema** (valor da equipe → frase marcante):
  ...
  | --------------------- | ----- | ----------------------------------------------------------------------------- | ----------------------------- |
  | Jeito de entregar     | 4     | "Nenhuma linha de código antes de entender o problema" → I05                  | fato (frase do site)          |
  | Mudanças e novidades  | 2     | empresa de produtos digitais adota ferramenta nova → I06 = 1                  | inferência                    |
  | Aprender coisas novas | 4     | equipe pequena passa por sites, automações, consultoria → I11                 | inferência de porte           |
  | Pensar em quem recebe | 2     | "Ciclos curtos, com você validando cada etapa" → I17 = 1                      | fato (frase do site)          |
  | Segurança e respeito  | 4     | "Ninguém some por três meses pra voltar com surpresa" → I25                   | fato (frase do site)          |
  | Ritmo do turno        | 2     | vários clientes ao mesmo tempo → I27                                          | inferência de porte e serviço |
  | Regras e decisões     | 2,5   | tenta o jeito novo antes de mapear tudo → I33 = 1                             | inferência                    |
  | Convivência           | 5     | "Sem intermediários: você fala com quem escreve o código" → I39               | fato (frase do site)          |
  | Autonomia             | 4,5   | "feitos por quem você conhece pelo nome" → I40; validação por etapa → I41 = 4 | fato + inferência             |
  | Carreira e futuro     | 3,5   | produtos variados (Crema, Brio, sites) → I50                                  | inferência                    |

  A gestão (declaração pela tela, sem convite) difere da equipe em **Ritmo do turno** (acha que se faz uma coisa de cada vez). É a divergência que a analista comenta na demonstração.

- **Amostra na base:** 10 convites de equipe respondidos e um 11º enviado em 13/09, ainda no prazo (a cena de "cobrar 1 que falta"); gestão declarou os 10 temas. Perfil **fechado** nos 10 temas. Frases eleitas para o candidato: I05, I06, I11, I17, I25, I27, I33, I39, I40, I50.
...
- **Mapeamento:** Jeito de entregar 4 (integridade → I02); Mudanças 3,5 (procedimento de armazém → I07, inferência de setor); Aprender 3 (gestão participativa → I14 = 1); Pensar em quem recebe 3 (comprometimento → I19 = 1); Segurança 4,5 (inferência: segurança em operação agroindustrial → I25); Ritmo 3 (rotina de armazém → I28); Regras 4 (programa de integridade → I31); Convivência 4 (humildade, gestão participativa → I38); Autonomia 3 (simplicidade → I42, inferência); Carreira 4 (safra reorganiza horários → I47, inferência de setor).
...
- **Mapeamento:** Jeito de entregar 3,5 (pátio de fracionada → I03 = 1, inferência); Mudanças 3,5 ("Padrão de Qualidade" → I09); Aprender 3,5 ("Profissionais Capacitados" → I15); Pensar em quem recebe 3,5 ("Parcerias Duradouras" → I19 = 1); Segurança 4 ("Segurança em Ponto de Apoio" → I25); Ritmo 1,5 (carga fracionada alterna → I26, inferência de setor); Regras 3,5 (decisão rápida no pátio → I32, inferência); Convivência 4,5 (combinado na doca → I39, inferência); Autonomia 4,5 (cada conferente na sua doca → I40, inferência); Carreira 4 (escala muda com a rota → I47).
...
- **Mapeamento:** Jeito de entregar 4 (comprometimento → I04); Mudanças 2,5 (missão "inovar" → I08); Aprender 4 (empreendedorismo → I11); Pensar em quem recebe 3 (sem frase que sustente; a eleita, I20, sai do ruído); Segurança 4,5 (ética, sustentabilidade → I25); Ritmo 3,5 (almoxarifado de matriz → I28, inferência); Regras 4 (ética → I31); Convivência 3,5 (simplicidade → I39); Autonomia 4 (inferência → I40); Carreira 3,5 ("Prêmio por Tempo de Empresa" → I45).
...
A base é completa por decisão do dono do produto: todo candidato das vagas novas respondeu o questionário, toda amostra fechou os 10 temas e toda remessa tem desfecho. A única pendência é o candidato da demonstração, que responde ao vivo. Fora das empresas reais, a Oficina Pantanal (EMP-03) continua como o único exemplo de perfil que não fechou, por ser pedagógico, e a Cerrado (EMP-01) passou a 10 de 10 mantendo a divergência gestão × equipe em Autonomia.
